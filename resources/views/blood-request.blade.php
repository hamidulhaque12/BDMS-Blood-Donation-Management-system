            ...
            <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <form  method="POST" action="{{route('bloodreq-user-store')}}" class="mb-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="hospital_name" id="hosptName" placeholder="Ex: Lab-8,Uttara" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="formFile" class="control-label text-primary">Upload Any Authorised Blood requirement
                                    copy</label>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary w-100"  id="BTN" name="submit"><i class="fa fa-send"></i>
                                    Request
                                    Now</button>
                            </div>
                        </form>
