                        ...
                        <tr>
                            <td align="center"
                                ...
                                <div style="line-height: 35px">
                                    ...
                                    Thanks For Using  <span style="color: #f80202;">BDMS</span>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <p style="line-height: 24px;margin-bottom:15px;">
                                                    We received  your Blood request for {{$patient_name}}, <b>"{{$blood_group}}"</b>  in "{{$hospital_name}}".<br> Don't worry our admin will approve your request as soon as possible. 

                                                </p>
                                                <p style="line-height: 24px; margin-bottom:20px;">
                                                    Please note your request number
                                                </p>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <div style="line-height: 22px;">
                                                                    <span 
                                                                        style="color: #ffffff; text-decoration: none;">{{$request_no}}</span>
                                                                </div>
                                                            </td>
                                                        </tr>
