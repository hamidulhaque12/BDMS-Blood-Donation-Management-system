                        ...
                        <tr>
                            <td align="center"
                                ...
                                <div style="line-height: 35px">
                                    ...
                                    Your Blood Request #id <span style="color: #f80202;">{{$request_no}}</span> has been Rejected
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <p style="line-height: 24px;margin-bottom:15px;">
                                                    Your Blood request #id{{$request_no}}  for {{$patient_name}}, <b>"{{$blood_group}}"</b>  in "{{$hospital_name}}" has been rejected by one of our admins.
