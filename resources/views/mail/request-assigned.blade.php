                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <p style="line-height: 24px;margin-bottom:15px;">
                                                    Hello! you had a blood seeking request <b>#id{{$request_no}}</b>, which is now assigned to related donors. 

                                                </p>
                                                <p style="line-height: 24px; margin-bottom:20px;">
                                                    Once a donor accept your seeking request, we will notify you. 
                                                </p>
